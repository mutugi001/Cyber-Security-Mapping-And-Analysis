...
<html
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('assets/admin/img/favicon/icon.png')}}" />
          ...
          <div class="app-brand demo">
            <a href="{{route('admin.home')}}" class="app-brand-link">
              <span class="app-brand-logo demo">
                <img src="{{asset('assets/admin/img/favicon/logo.png')}}" alt="" width="200" height="60" class="logo-image">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">CyberArc</span> --}}
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item active open">
                  <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <div data-i18n="Dashboards">NewsFeeds</div>
                  </a>
                  <ul class="menu-sub">
                    <li class="menu-item">
                ...
                <li class="menu-item">
                  <a
                    href="{{route('admin.subscribed-user')}}" class="menu-link">
