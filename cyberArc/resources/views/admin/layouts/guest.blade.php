...
<html
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../assets/admin/img/favicon/icon.png" />
              ...
              <div class="app-brand justify-content-center">
                <a href="/" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <img src="{{asset('assets/admin/img/favicon/logo.png')}}" alt="" width="397" height="85" class="logo-image">
                    {{-- <svg
                      width="25"
                      viewBox="0 0 25 42"
                      version="1.1"
                  ...
                  {{-- <span class="app-brand-text demo text-body fw-bold">CyberArc</span> --}}
                </a>
              </div>
              @yield('auth')
