...
<head>
  ...
  <link rel="icon" href="clientimages/img_2.png">
...
<!--                <div class="btn btn-sm border rounded-pill text-primary px-3 mb-3">Case Study</div>-->
                <h1 class="mb-4">Explore and attend our Events</h1>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="case-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="case-overlay text-decoration-none" href="{{route('event.register', $event['id'])}}">
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <a class="btn btn-link" href="about.html">Learn</a>
                    <a class="btn btn-link" href="contact.html">Contact Us</a>
                    <a class="btn btn-link" href="service.html">Solution</a>
                    <a class="btn btn-link" href="project.html">Events</a>
